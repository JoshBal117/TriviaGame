$(document).ready(function() {
    ...
    let trivQuestions = [{
            ...
            Answers: ["700 years old" , "800 years old" , "900 years old" , "1100 years old"],
            correctAnswer: "3"
    },
    {
            Question: "Luke wanted to get what from Tosche Station?",
            Answers:["Power Couplings" , "Power Converters" , "Droid Inhibitor" , "Lightsaber"],
            correctAnswer: "2"
    },
    {
            Question: "Anakin is what as a child?",
           Answers:["A Jedi" , "A Store Owner" , "A Pilot" , "A Slave"],
           correctAnswer: "4"
    },
    {
            Question: "Obi Wan Kenobi is called what by Princess Leia?",
            Answers:["An Old Goat" , "General Kenobi" , "Ben Kenobi",  "The Negotiator"],
            correctAnswer: "2"
    },
    {
            Question: "Who is pursuing the Rebel Blockade Runner in Episode IV?",
            Answers:["Darth Vader" ,  "Darth Maul" ,  "Darth Tyranus" ,  "Darth Bane"],
            correctAnswer: "1"            
    },
